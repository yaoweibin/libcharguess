...
#ifndef SJISProber_h__
#define SJISProber_h__
...
class SJISProber: public CharSetProber {
public:
  SJISProber(void){mCodingSM = new CodingStateMachine(&SJISSMModel);
                      Reset();};
  virtual ~SJISProber(void){delete mCodingSM;};
