...
#ifndef EUCTWProber_h__
#define EUCTWProber_h__

#include "charsetProber.h"
#include "codingStateMachine.h"
#include "charDistribution.h"

class EUCTWProber: public CharSetProber {
public:
  EUCTWProber(void){mCodingSM = new CodingStateMachine(&EUCTWSMModel);
                      Reset();};
  virtual ~EUCTWProber(void){delete mCodingSM;};
