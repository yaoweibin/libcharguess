...
#ifndef MBCSGroupProber_h__
#define MBCSGroupProber_h__
...
class MBCSGroupProber: public CharSetProber {
public:
  MBCSGroupProber();
  virtual ~MBCSGroupProber();
...
protected:
  ProbingState mState;
  CharSetProber* mProbers[NUM_OF_PROBERS];
  PRBool          mIsActive[NUM_OF_PROBERS];
  PRInt32 mBestGuess;
  PRUint32 mActiveNum;
};

#endif /* MBCSGroupProber_h__ */
